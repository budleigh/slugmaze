...
var Cell = function (_Entity) {
  ...
  _createClass(Cell, [{
    key: 'hasPath',
    value: function hasPath(dir) {
      return !!this.paths[dir];
    }
  }, {
    key: 'openPath',
    value: function openPath(dir) {
      this.paths[dir] = true;
    }
  }, {
    key: 'closeAllPaths',
...
},{"./Entity.js":19,"./dirs.js":26,"lodash":16}],18:[function(require,module,exports){
'use strict';
...
var Director = function () {
  ...
  _createClass(Director, [{
    ...
    value: function clearPathAtPlayer() {
      // clear off any paths that were already
      this.maze.closeAllPaths();

      var _maze$getPlayerGridCo = this.maze.getPlayerGridCoords();
...
},{"./Maze.js":23,"./Path.js":24}],19:[function(require,module,exports){
"use strict";
...
},{"./Director.js":18,"./Input.js":22}],21:[function(require,module,exports){
"use strict";
...
var Input = function () {
  ...
  _createClass(Input, [{
    ...
    value: function addDocumentListeners() {
      var _this = this;
      ...
      document.onkeydown = function (e) {
        ...
        if (key) {
          _this.instantaneousInput[key] = true;
          e.preventDefault();
        }
      };
      ...
      document.onkeyup = function (e) {
        ...
        if (key) {
          _this.instantaneousInput[key] = false;
          e.preventDefault();
        }
      };
    }
    ...
    value: function getPressedKeys() {
      ...
      return (0, _lodash.filter)(this.keymap, function (key) {
        return _this2.isPressed(key);
      });
    }
  }, {
    key: 'update',
    value: function update() {
      ...
      (0, _lodash.each)(this.keymap, function (key) {
        _this3.lastFrameInput[key] = _this3.currentFrameInput[key];
        _this3.currentFrameInput[key] = _this3.instantaneousInput[key];
      });
    }
  }]);
...
var Maze = function (_Entity) {
  ...
  function Maze(x, y, cellWidth, cellHeight, cellsPerSide) {
    _classCallCheck(this, Maze);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Maze).call(this, x, y, cellWidth * cellsPerSide, cellHeight * cellsPerSide));
  ...
  _createClass(Maze, [{
    ...
    value: function handleInput(keys) {
      ...
      if (this.isValidInput(dir)) {
        ...
        if ((0, _lodash.isEqual)(this.player.getGridCoords(), this.goal)) {
    ...
    key: 'isValidInput',
    value: function isValidInput(dir) {
      return this.cells.read(this.player.gridX, this.player.gridY).hasPath(dir);
    }
  }, {
    key: 'update',
    value: function update(dt, keys) {
...
},{"./Cell.js":17,"./Entity.js":19,"./Grid.js":21,"./Path.js":24,"./Player.js":25,"./dirs.js":26,"event-emitter":15,"lodash":16}],24:[function(require,module,exports){
'use strict';
...
var Path = function () {
  ...
  _createClass(Path, null, [{
    ...
    value: function delta(path) {
      ...
      Path.each(0, 0, path, function (x, y, idx) {
        if (idx === path.length) result = { x: x, y: y };
      });
...
},{"./Grid.js":21,"./dirs.js":26,"lodash":16}],25:[function(require,module,exports){
'use strict';
...
var Player = function (_Entity) {
  ...
  function Player(cell, gridX, gridY, w, h) {
    _classCallCheck(this, Player);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Player).call(this, 0, 0, w, h));
    // leave the position at the origin because we'll compute it next


    _this.moveToCell(cell, gridX, gridY);
    return _this;
  }

  _createClass(Player, [{
    key: 'moveToCell',
    value: function moveToCell(cell, gridX, gridY) {
...
},{"./Entity.js":19}],26:[function(require,module,exports){
'use strict';
